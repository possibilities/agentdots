...
flowchart LR
    ...
    surface -->|host popup: agentlaunch --x-surface, directives back over the sink| launch
    ...
    herdr -.->|plugin: launch popup; pane.agent_detected + agent_status_changed → project token + name-tab| surface
...
and a future resume app plugs in the same way.
