...
flowchart LR
    ...
    herdr -.->|plugin: launch popup; pane.agent_detected → name-tab| surface
...
all-catalog cycling and live reload. Updated again 2026-08-16 to make the
